...
export const initiateSSL = async (req, res) => {
    ...
    let data = {
        ...req.body,
        currency: 'BDT',
        success_url: `${req.protocol}s://${req.get('host')}/api/payment/ssl-validate`,
        fail_url: `${req.protocol}s://${req.get('host')}/api/payment/ssl-fail`,
        cancel_url: `${req.protocol}s://${req.get('host')}/api/payment/ssl-cancel`,
